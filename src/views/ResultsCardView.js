    ...
    handleBodyElement = (playerScore) => {
        ...
        return {
            keyValue: {
                ...
                bottomLabel: utils.getShootsDeclination(shoots) + labels.IN_SMTH.format(utils.getTournamentsDeclination(tournamentsNum)) + ', średnio: ' + parseFloat(shootsAvg).toFixed(2)
            }
        }
    };
};